...
$sendToEmail = 'forexpeter@gmail.com';
...
try
{
    ...
    $emailTextHtml .= "<h3>New message from the PTA:</h3><hr>";
    $emailTextHtml .= "<table>";
    ...
    $emailTextHtml .= "<p>Have a great day!<br><br>Sincerely,<br><br>Peter T Akinbinu</p>";
...
$mail->IsSMTP();
                ...
                $mail->Username = "forexpeter26@gmail.com";
                $mail->Password = "ForexPeter26";
